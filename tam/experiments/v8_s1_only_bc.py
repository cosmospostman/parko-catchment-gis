"""v8_s1_only_bc — S1 temporal only, Barcoorah as transfer val site.

Train: Norman Road + Cloncurry + Lake Mueller (arid presence added).
Val holdout: Barcoorah (arid, unseen during training).
Tests whether S1 temporal signal transfers across climate zones once
arid-zone presence is included in training.
"""
