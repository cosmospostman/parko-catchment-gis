"""tam/experiments/v4_spectral.py — Spectral bands + NDVI/NDWI/EVI indices (V4).

Extends V3 with n_obs as an explicit model input to reduce inter-tile stripe
artefacts caused by systematic observation count differences between S2 tiles.
"""
