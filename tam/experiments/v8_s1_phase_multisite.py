"""v8_s1_phase_multisite — S1 temporal, phase shift, multi-site, Lake Mueller holdout.

Train: Norman Road + Cloncurry + Barcoorah + Stockholm (two monsoonal, two arid).
Val holdout: Lake Mueller (arid, unseen during training).
Phase shift augmentation + tuned hyperparams (lr=5e-6, dropout=0.6) to stabilise
cross-site learning and test SAR curve shape transferability.
"""
