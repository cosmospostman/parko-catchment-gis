"""v8_s1_only_nr_lm_phase_bc — S1 temporal, phase shift, Barcoorah holdout.

Train: Norman Road + Cloncurry + Lake Mueller (arid presence diversity).
Val holdout: Barcoorah (arid, unseen during training).
Phase shift augmentation forces model to learn SAR curve shape rather than
calendar-time patterns, testing cross-climate-zone transferability.
"""
...
EXPERIMENT = Experiment(
    name="v8_s1_only_nr_lm_phase_bc",
    region_ids=[
