"""v8_s1_pure_nr_lm — S1 temporal + S1 globals, Norman Road + Cloncurry + Lake Mueller.

No site holdout — spatial val_frac split within training sites.
Baseline to check whether adding arid-zone Lake Mueller presence
improves discrimination before testing Barcoorah transfer.
"""
