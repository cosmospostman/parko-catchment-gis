"""v8_s1_zscore_nr_etna_landsend_lm_corfield — adds Lake Mueller and Corfield to the etna_landsend experiment.

Extends v8_s1_zscore_nr_etna_landsend with:
  - Lake Mueller (arid, riparian) — presence + absence
  - Corfield (semi-arid, cropland hard negative) — presence + absence
"""
...
EXPERIMENT = Experiment(
    name="v8_s1_zscore_nr_etna_landsend_lm_corfield",
    region_ids=[
        # Norman Road
        ...
        # Corfield (includes cropland hard negatives)
