"""v8_globals_only — S1 global features only, no S1 time series.

Same sites as v8 but use_s1=False so the transformer only sees S2 bands.
S1 global features (s1_mean_vh_dry, s1_vh_contrast, s1_vh_std, s1_mean_rvi)
are still computed and passed to the classification head via n_global_features=9.
"""
...
EXPERIMENT = Experiment(
    ...
    train_kwargs={
        ...
        "use_s1":          False,   # S2 time series only
    },
)
