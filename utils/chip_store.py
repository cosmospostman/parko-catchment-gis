"""utils/chip_store.py — ChipStore protocol and in-memory implementation.
...
DiskChipStore   : reads from inputs/ populated by Stage 0 fetch.
                  See pipelines/legacy/chip_store.py.
"""
